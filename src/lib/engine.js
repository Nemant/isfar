/* ===========================================================================
   ...
   ES-module port: `adhan` is now an npm import and `META` comes from the data
   module. The compute() OUTPUT CONTRACT is unchanged — same model shape,
   same fields, same numbers.
   =========================================================================== */
